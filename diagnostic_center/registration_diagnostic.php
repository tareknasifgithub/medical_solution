 <?php
   include('../db_connect.php');
    include('diagnostic_header.php');
    $diagnostic_id = $_SESSION['diagnostic_id'];
$sql = "select * from diagnostic_info where id = $diagnostic_id";
...
<!-- Form Name -->
<legend><center><h2><b>Basic Info</b></h2></center></legend><br>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="drag_reg_no" id = "drag_reg_no"  value = "<?php echo $row['drag_reg_no'];?>" class="form-control"  type="text">
    </div>
  </div>
</div>
<!-- Text input-->
  ...
  $(document).ready(function() {
    $("#sign_up_button_diagnostic").click(function(){
      if(form_validation())
      {
        ...
        var diagnostic_id = <?php echo $diagnostic_id?>;
