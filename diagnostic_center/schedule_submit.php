...
$check_row = "select * from diagnostic_schedule where diagnostic_id = $diagnostic_id";

 $result = mysqli_query($conn,$check_row);
        //echo "<pre>"; print_r($result->num_rows);exit();
        if($result->num_rows == 1)
        	{
				$update_row = "update diagnostic_schedule set visiting_day_string = '$visiting_day_string', non_visiting_day_string = '$non_visiting_day_string', reservation_date_from = '$reservation_date_from', reservation_date_to = '$reservation_date_to', slot_1_start_time = '$slot_1_start_time', slot_1_end_time ='$slot_1_end_time', slot_2_start_time = '$slot_2_start_time', slot_2_end_time = '$slot_2_end_time', slot_3_start_time = '$slot_3_start_time', slot_3_end_time = '$slot_3_end_time' WHERE diagnostic_id = $diagnostic_id";
				...
				if ($conn->query($update_row) === TRUE) {
					...
					$insert_sql = "INSERT INTO diagnostic_schedule (diagnostic_id,visiting_day_string, non_visiting_day_string,reservation_date_from,reservation_date_to,slot_1_start_time,slot_1_end_time,slot_2_start_time,slot_2_end_time,slot_3_start_time,slot_3_end_time)
					VALUES ($diagnostic_id,'$visiting_day_string','$non_visiting_day_string','$reservation_date_from','$reservation_date_to','$slot_1_start_time','$slot_1_end_time','$slot_2_start_time','$slot_2_end_time','$slot_3_start_time','$slot_3_end_time')";
