...
//echo $user_id;
$sql = "SELECT `user_id`, `date`,user_info.name as user_name, diagnostic_info.name as diagnostic_name, `start_time`, `end_time`, `diagnostic_id`, user_diag_schedule_table.`status`
