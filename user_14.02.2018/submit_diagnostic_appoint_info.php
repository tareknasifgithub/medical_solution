...
include('../db_connect.php');
 //print_r($_POST); exit;
	...
	$trxid = $_POST['trxid'];
				...
				$insert_sql = "INSERT INTO user_diag_schedule_table (diagnostic_id,test_id,user_id,`date`,start_time,end_time,status)
				VALUES ($diagnostic_id,$test_id,$user_id,'$date','$start_time','$end_time',0)";
