 ...
 $sql = "SELECT id, test_name FROM sample_test";
 //echo $sql; exit;$
    ...
    <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
               ...
               <input type = "text" disabled="disabled" id= "doctor_name" name = "doctor_name" class="form-control" value = "<?php echo $doctor_name?>">
              </div>
            </div>            
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
               ...
               <input type = "text" disabled="disabled" id = "patient_name" class="form-control" value = "<?php echo $user_name?>">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Age</label>
              <input type = "text" disabled="disabled" id = "age" class="form-control" value = "<?php echo $user_age?>">
              </div>
            </div>
			<div class="col-md-3">
              <div class="form-group">
                <label>Gender</label>
              <input type = "text" disabled="disabled" id = "gender" class="form-control" value = "<?php echo $user_gender?>">
              </div>
            </div>
             <div class="col-md-3">
              <div class="form-group">
      ...
      <div class="row">
              ...
              <div class="form-group">
               ...
               <select class="form-control select2" id = "select_test" multiple="multiple"  data-placeholder="Select Test">
                  <?php
                    ...
                    foreach($test_array as $t_array){?>
                  
                  <option value = "<?php echo $t_array['id'];?>"><?php echo $t_array['test_name'];?></option>
                  <?php }?>
                </select>
        ...
        <div class="control-group" id="fields">
            <label class="control-label" for="field1">More Tests</label>
			...
			var doctor_id = '<?php echo $doctor_id?>';
              ...
              var select_test_id=[];
               $('#select_test :selected').each(function(){
                   ...
                   select_test_id[$(this).val()]=$(this).val();
                   //select_test[$(this).val()]=$(this).text();
                  });
                  var input_test = [];               
                  var each_input;   
