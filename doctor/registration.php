...
<div class="form-group">
  <label class="col-md-4 control-label" >Designation</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="designation" id = "designation" value = "<?php echo $row['designation'];?>" placeholder="Designation" class="form-control"  type="text">
    </div>
  </div>
</div>
  ...
  <label class="col-md-4 control-label">Speciality</label>
    ...
    <select name="speciality" id = "speciality" class="form-control selectpicker">
      ...
      <option value="1" <?php if($row['specialist_area_id'] == 1){echo 'selected = "selected"';}?>>Cerdiology</option>    
      <option value="2"<?php if($row['specialist_area_id'] == 2){echo 'selected = "selected"';}?>>Dental</option>    
      <option value="3"<?php if($row['specialist_area_id'] == 3){echo 'selected = "selected"';}?>>Dermalogy</option>    
      <option value="4"<?php if($row['specialist_area_id'] == 4){echo 'selected = "selected"';}?>>Gastroenterology</option>    
      <option value="5"<?php if($row['specialist_area_id'] == 5){echo 'selected = "selected"';}?>>Medicine</option> 
      <option value="6"<?php if($row['specialist_area_id'] == 6){echo 'selected = "selected"';}?>>Orthopaedics</option> 
    </select>
  </div>
</div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="bmdc_reg_no" id = "bmdc_reg_no"  value = "<?php echo $row['bmdc_reg_no'];?>" placeholder="BMDC Registration Number" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Confirm Password</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="confirm_password" id = "confirm_password" value = "<?php echo $row['password'];?>" placeholder="Confirm Password" class="form-control"  type="password">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Description (professional statement)</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <textarea name="description" id = "description" value = "<?php echo $row['description'];?>" placeholder="Description (professional statement)" class="form-control"  type="text"></textarea>
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Degree & Other Specification</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <textarea name="degree_and_other_specification" id = "degree_and_other_specification" value = "<?php echo $row['degree_and_other_specification'];?>" placeholder="Degree & Other Specification" class="form-control"  type="text"></textarea>
    </div>
  </div>
</div>
