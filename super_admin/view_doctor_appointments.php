...
ORDER BY user_schedule_table.date DESC";
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                ...
                <tr>
                  ...
                  <?php if( $aa['status'] == 0){?>
                 <td> <a href="doctor_appoinment_accept.php?schedule=<?php echo $aa['schedule_id'];?>&stts=1" <i class = "fa fa-check-circle" title="Accept" style="font-size: 30px;"></i></a>

                 <a href="doctor_appoinment_accept.php?schedule=<?php echo $aa['schedule_id'];?>&stts=2" <i class = "fa fa-times-circle-o" title="Reject" style="font-size: 30px;"></i></a></td>
                  <?php } ?>
                  <?php if( $aa['status'] == 1){?>
