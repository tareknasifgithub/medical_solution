...
user_info.gender,
user_info.contact,
diagnostic_info.id as diagnostic_id,
diagnostic_info.name as diagnostic_name,
user_diag_schedule_table.id as schedule_id,
user_diag_schedule_table.date as `date`,
user_diag_schedule_table.trxid,
user_diag_schedule_table.cost,
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                ...
                <tr>
                  ...
                  <?php if( $aa['status'] == 0){?>
                 <td> <a href="diag_appoinment_accept.php?schedule=<?php echo $aa['schedule_id'];?>&diagnostic_id=<?php echo $aa['diagnostic_id'];?>&stts=1&date=<?php echo $aa['date'];?>" <i class = "fa fa-check-circle" title="Accept" style="font-size: 30px;"></i></a>
